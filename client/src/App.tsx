...
const AdminDealAdd = lazy(() => import("@/pages/admin/deals/add"));
const AdminDealEdit = lazy(() => import("@/pages/admin/deals/edit/[id]"));
const AdminUsers = lazy(() => import("@/pages/admin/users"));
const AdminUserDetail = lazy(() => import("@/pages/admin/users/[id]"));
const AdminAnalytics = lazy(() => import("@/pages/admin/analytics"));

// Vendor pages
const VendorDashboard = lazy(() => import("@/pages/vendor"));
const CreateDeal = lazy(() => import("@/pages/vendor/deals/create"));
const EditDeal = lazy(() => import("@/pages/vendor/deals/edit/[id]"));
const ManageDeal = lazy(() => import("@/pages/vendor/deals/manage/[id]"));
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/admin/deals/add">
        {(params) => (
          <Suspense fallback={<LoadingFallback />}>
            <AuthenticatedRoute component={AdminDealAdd} params={params} />
          </Suspense>
        )}
      </Route>
      ...
      <Route path="/admin/users/:id">
        {(params) => (
          <Suspense fallback={<LoadingFallback />}>
            <AuthenticatedRoute component={AdminUserDetail} params={params} />
          </Suspense>
        )}
      </Route>
      ...
      <Route path="/vendor/deals/edit/:id">
        {(params) => (
          <Suspense fallback={<LoadingFallback />}>
            <AuthenticatedRoute component={EditDeal} params={params} />
          </Suspense>
        )}
      </Route>
      
      <Route path="/vendor/deals/manage/:id">
        {(params) => (
          <Suspense fallback={<LoadingFallback />}>
            <AuthenticatedRoute component={ManageDeal} params={params} />
          </Suspense>
        )}
      </Route>
