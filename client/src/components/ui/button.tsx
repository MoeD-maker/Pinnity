...
/**
 * Button variants with responsive icon spacing
 * - Uses size-based gap spacing for better visual hierarchy:
 *   - Small (sm) buttons: gap-1 for tighter spacing
 *   - Icon buttons: gap-1.5 for compact layout
 *   - Default and large (lg) buttons: gap-2 for standard spacing
 */
